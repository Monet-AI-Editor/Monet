    ...
    <div className="flex h-full flex-col overflow-hidden bg-surface-1">
      ...
      {showGuide && (
        <div className="border-b border-border bg-[#111318] px-3 py-3">
          <div className="select-text text-xs font-semibold text-text-primary">Tips for coding agents</div>
          ...
          <div className="mt-2 rounded bg-[#0f1115] px-2 py-2 text-[10px] leading-relaxed text-text-dim">
            If an agent loses context, tell it plainly:
            <code className="ml-1 select-text text-text-secondary">hey I am in the Monet app, can you look at my current project?</code>
          </div>
        ...
        <div className="border-b border-border bg-[#111318] px-3 py-3">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="mt-3 rounded bg-[#0f1115] px-2 py-2 text-[10px] leading-relaxed text-text-dim">
                After installing, run <code className="text-text-secondary">claude</code> or <code className="text-text-secondary">codex</code> in this terminal.
              </div>
